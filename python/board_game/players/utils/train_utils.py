...
def add_train_arguments(parser):
    ...
    parser.add_argument('--check_interval', type=int, default=100, help='check interval')
...
def get_exploring_starts(exploring_starts, smemory):
    exploring_starts_ratio, exploring_starts_action_num = exploring_starts
    is_exploring_starts = exploring_starts_ratio > 0 and random.random() < exploring_starts_ratio and smemory.has_action_num(exploring_starts_action_num)
    if is_exploring_starts:
        start_state = smemory.sample(exploring_starts_action_num).clone()
    else:
        start_state = None
